...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Route exact path="/" render={(props) => <Home {...props} savedBookList={savedBookList} setSavedBookList={setSavedBookList} recommendedBooks={recommendedBooks} setRecommendedBooks={setRecommendedBooks}/>}
/>
